...
// 9
{
  question: "წრეწირში ჩახაზული $ABCD$ ტრაპეციის $AC$ დიაგონალი $12$-ის ტოლია. ტრაპეციის თითოეული ფერდი ცენტრიდან $120^\\circ$-იანი კუთხით მოჩანს. იპოვეთ ტრაპეციის შუახაზი.",
...
// 10
{
  question: "მახვილკუთხა $ABC$ სამკუთხედზე შემოხაზული წრეწირის ცენტრია $O$. სამკუთხედის $A$ წვეროდან გავლებულია $AH$ სიმაღლე. იპოვეთ $\\angle OAC$, თუ $\\angle BAH = 40^\\circ$.",
...
// 21
{
  question: "ჩამოთვლილი ექვსი ტოლობიდან რამდენი სრულდება ნებისმიერი $\\alpha$ მახვილი კუთხისათვის?\n\n(a) $2 + \\tg^2 \\alpha = \\frac{\\cos^2 \\alpha + 1}{\\cos^2 \\alpha}$\n(b) $\\tg \\alpha \\cdot \\ctg \\alpha = 1$\n(c) $1 + \\ctg^2 \\alpha = \\frac{1}{\\sin^2 \\alpha}$\n(d) $\\frac{\\sin \\alpha - 3 \\cos \\alpha}{2 \\sin \\alpha - 2 \\cos \\alpha} = \\frac{1}{2}$\n(e) $\\sin^2 \\alpha + \\cos^2 \\alpha = 1$\n(f) $(\\sin \\alpha + \\cos \\alpha)^2 = 1 + 2 \\sin \\alpha \\cos \\alpha$",
