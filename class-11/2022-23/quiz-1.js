...
const quizData = [
  {
    question: "\\მოქცეულია \\((-1; 1)\\) ინტერვალში განსაზღვრული ფუნქციები: \\\\ \\(F(x) = x^2\\), \\(G(x) = x^3\\), \\(T(x) = 3^x\\), \\(L(x) = \\sin x\\), \\(K(x) = \\cos x\\). \\\\ \\text{ჩამოთვლილთაგან რამდენ ფუნქციას გააჩნია შექცეული ფუნქცია?}",
