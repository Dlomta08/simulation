const quizData = [
  ...
  {
    question: "$Oxy$ საკოორდინატო სიბრტყეზე აღნიშნეს ყველა იმ $(x;y)$ კოორდინატებიანი წერტილთა სიმრავლე რომლებისთვისაც $\log_{(3 - |y|)} (2 - |x|)$ გამოსახულება განსაზღვრულია. იპოვეთ მიღებული ფიგურის ფართობი.",
